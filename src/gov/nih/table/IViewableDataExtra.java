 ...
 */
public interface IViewableDataExtra extends Iterable<double[]>
{
	...
	// public IViewableDataExtra createView(IDataFilter filter);
	// public IViewableDataExtra createView(int columnNo, double value);
